...
export default function App() {
  ...
  const mgmCounts = { sport: mgmResults?.sport?.length||0, casino: mgmResults?.casino?.length||0, deposit: mgmResults?.deposit?.length||0 };
    ...
    <div className="app">
      ...
      <div className="main-wrapper">
        ...
        <main className="main">
          ...
          {page === 'betshop-marches'  && <BetshopMarchesPage />}
          {page === 'betshop-periodes' && <BetshopMultiPeriodesPage />}
