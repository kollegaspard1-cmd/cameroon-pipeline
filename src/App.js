...
export default function App() {
  ...
  const [mgmResults, setMgmResults]         = useState(null); // shared MGM state
        ...
        <nav style={{ padding: '0.5rem 0.75rem', flex: 1, overflowY: 'auto' }}>
          {NAV.map(group => (
            <div key={group.section} style={{ marginBottom: '0.1rem' }}>
              <div className="sidebar-section-label" style={{ marginTop: '1rem', marginBottom: '2px' }}>
                {group.section}
              </div>
